...
const Implementation = ({go, responces, next, activeQue, previous, quest, name, setName, activeField, setActiveField, activeQuestionnaire, sub, setSub, setActiveQuestionnaire}) => {
          ...
          <div className="elements_wrapper"> 
            {page3?.elements.map((e, i) => (                         
             ...
             <button 
              ...
              onClick={handleNext} 
              disabled={!isValid}
              >{sending? 'Please wait' : 'Submit'}</button> 
