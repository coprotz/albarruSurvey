...
const Power = ({next, previous, go, formData, setForm}) => {

    const {power} = formData
  return (
    ...
    <motion.div 
        ...
        <div className='ques_2'>
            <h3 className='body_que'>Lack of reliable power supply</h3>
            <div className="radio" value={power} onChange={setForm}>
                <input type="radio" className="radio_input" value='1' name='power' id='1'/>
                <label htmlFor="1" className='radio_label'  >Strong Disagree</label>
                <input type="radio" className="radio_input" value='2' name='power' id='2'/>
                <label htmlFor="2" className='radio_label'  >Disagree</label>   
                <input type="radio" className="radio_input" value='3' name='power' id='3'/>
                <label htmlFor="3" className='radio_label'  >Neutral</label> 
                <input type="radio" className="radio_input" value='4' name='power' id='4'/>
                <label htmlFor="4" className='radio_label'  >Agree</label> 
                <input type="radio" className="radio_input" value='5' name='power' id='5'/>
