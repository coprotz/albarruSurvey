  ...
  return (
    ...
    <motion.div 
        ...
        <div className='ques_2'>
            <h3 className='body_que'>How do you rate the effectiveness of legal frameworks on the implementation of e-Procurement system on the public construction projects from the following scenarios</h3>
