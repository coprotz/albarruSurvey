...
const Boq = ({next, previous, go, formData, setForm}) => {
  ...
  return (
    ...
    <motion.div 
        ...
        <div className='ques_2'>
            <h3 className='body_que'>Fill electronic BOQ, forms, etc and no download and upload of hardcopies</h3>
            <div className="radio" value={boq} onChange={setForm}>
                <input type="radio" className="radio_input" value='1' name='boq' id='1'/>
                <label htmlFor="1" className='radio_label'  >Poor</label>
                <input type="radio" className="radio_input" value='2' name='boq' id='2'/>
                <label htmlFor="2" className='radio_label'  >Fair</label>   
                <input type="radio" className="radio_input" value='3' name='boq' id='3'/>
                <label htmlFor="3" className='radio_label'  >Good</label> 
                <input type="radio" className="radio_input" value='4' name='boq' id='4'/>
                <label htmlFor="4" className='radio_label'  >Very Good</label> 
                <input type="radio" className="radio_input" value='5' name='boq' id='5'/>
