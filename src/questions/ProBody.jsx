...
const ProBody = ({next, previous, go, setForm, formData}) => {

    const {probody} = formData
  return (
    ...
    <motion.div 
        ...
        <div className='ques_2'>
            <h3 className='body_que'>All professional bodies should be well equipped with the IT infrastructures</h3>
            <div className="radio" value={probody} onChange={setForm}>
                <input type="radio" className="radio_input" value='1' name='probody' id='1'/>
                <label htmlFor="1" className='radio_label'  >Strong Disagree</label>
                <input type="radio" className="radio_input" value='2' name='probody' id='2'/>
                <label htmlFor="2" className='radio_label'  >Disagree</label>   
                <input type="radio" className="radio_input" value='3' name='probody' id='3'/>
                <label htmlFor="3" className='radio_label'  >Neutral</label> 
                <input type="radio" className="radio_input" value='4' name='probody' id='4'/>
                <label htmlFor="4" className='radio_label'  >Agree</label> 
                <input type="radio" className="radio_input" value='5' name='probody' id='5'/>
