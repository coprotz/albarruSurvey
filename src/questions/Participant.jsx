...
const Participant = ({next, previous, go, setForm, formData}) => {
  ...
  return (
    ...
    <motion.div 
        ...
        <div className='ques_2'>
            <h3 className='body_que'>How is your firm participation in tendering through TANeps ?</h3>
            <div className="radio" value={participant} onChange={setForm}>
                <input type="radio" className="radio_input" value='1' name='participant' id='1'/>
                <label htmlFor="1" className='radio_label'  >Poor</label>
                <input type="radio" className="radio_input" value='2' name='participant' id='2'/>
                <label htmlFor="2" className='radio_label'  >Fair</label>   
                <input type="radio" className="radio_input" value='3' name='participant' id='3'/>
                ...
                <input type="radio" className="radio_input" value='5' name='participant' id='5'/>
